    ...
    <div class="flex items-start justify-between">
      <div class="relative hidden h-screen shadow-lg lg:block w-80">
        <div class="h-full bg-white dark:bg-gray-700">
          <div class="flex items-center justify-start pt-6 ml-8">
            <p class="text-xl font-bold dark:text-white">Plannifer</p>
          </div>
          <nav class="mt-6">
            <div>
              <a
                class="flex items-center justify-start w-full p-2 pl-6 my-2 text-gray-800 transition-colors duration-200 border-l-4 border-purple-500 dark:text-white"
                href="#"
              >
              ...
              >
                ...
                <span class="mx-2 text-sm font-normal">
                  Refered Projects
                  <span
                    class="w-4 h-2 p-1 ml-4 text-xs text-gray-400 bg-gray-200 rounded-lg"
                  >
                    0
                  </span>
                </span>
      ...
      <div class="flex flex-col w-full md:space-y-4">
        <header class="z-40 flex items-center justify-between w-full h-16">
          ...
          <div
            class="relative z-20 flex flex-col justify-end h-full px-3 md:w-full"
          >
            <div
              class="relative flex items-center justify-end w-full p-1 space-x-4"
            >
              <button
        ...
        <div class="h-screen px-4 pb-24 overflow-auto md:px-6">
          ...
          <div
            class="flex flex-col items-center w-full my-6 space-y-4 md:space-x-4 md:space-y-0 md:flex-row"
          >
              ...
              >
                <a href="#" class="block w-full h-full">
                  ...
                  >
                    ...
                    <div
                      class="mt-6 text-xl font-bold text-black border-b border-gray-200 md:mt-0 dark:text-white"
                    >
                      $44,453.39
                  ...
                  <div class="w-full h-3 bg-gray-100">
                    <div
                      class="w-2/5 h-full text-xs text-center text-white bg-green-400"
                    ></div>
                  </div>
                </a>
              </div>
            ...
            <div class="flex items-center w-full space-x-4 md:w-1/2">
              <div class="w-1/2">
                <div
                  class="relative w-full px-4 py-6 bg-white shadow-lg dark:bg-gray-700"
                >
              ...
              <div class="w-1/2">
                ...
                >
                  ...
                  <span
                    class="absolute p-4 bg-purple-500 rounded-full top-2 right-4"
                  >
                    <svg
                      width="40"
                      fill="currentColor"
            ...
            <div class="w-full">
              ...
              >
                ...
                <div class="flex items-end my-6 space-x-2">
                  ...
                  <span
                    class="flex items-center text-xl font-bold text-green-500"
                  >
                    <svg
                      width="20"
                      fill="currentColor"
            ...
            <div class="w-full">
              ...
              >
                ...
                <div class="flex items-end my-6 space-x-2">
                  ...
                  <span
                    class="flex items-center text-xl font-bold text-red-500"
                  >
                    <svg
                      width="20"
                      fill="currentColor"
