...
<template>
  <div class="container max-w-2xl px-4 mx-auto sm:px-8">
    <div class="py-8">
      <div class="flex flex-row justify-between w-full mb-1 sm:mb-0">
        <h2 class="text-2xl leading-tight">投稿数ランキング</h2>
        <div class="text-end">
          <form
      ...
      <div class="px-4 py-4 -mx-4 overflow-x-auto sm:-mx-8 sm:px-8">
        ...
        >
          <table class="min-w-full leading-normal">
            ...
            <tbody>
              <tr v-for="(user, i) in users" class="hover:bg-slate-100">
