...
func (x *CreateArticleRequest) GetTagIds() []string {
	if x != nil {
		return x.TagIds
	}
	return nil
...
var file_proto_article_proto_rawDesc = []byte{
	...
	0xe7, 0x01, 0x0a, 0x07, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x61,
	...
	0x65, 0x22, 0x44, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65,
	...
	0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x73, 0x22, 0x78, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x32, 0xb0, 0x01, 0x0a, 0x0e, 0x41, 0x72, 0x74, 0x69, 0x63,
	...
	0x65, 0x74, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x73, 0x12, 0x1c, 0x2e, 0x61, 0x72, 0x74,
...
var file_proto_article_proto_goTypes = []interface{}{
	...
	(*CreateArticleResponse)(nil), // 4: article.CreateArticleResponse
...
var file_proto_article_proto_depIdxs = []int32{
	...
	0, // 2: article.ListArticlesResponse.articles:type_name -> article.Article
	0, // 3: article.CreateArticleResponse.article:type_name -> article.Article
	3, // 4: article.ArticleService.CreateArticle:input_type -> article.CreateArticleRequest
	1, // 5: article.ArticleService.GetArticles:input_type -> article.ListArticlesRequest
	4, // 6: article.ArticleService.CreateArticle:output_type -> article.CreateArticleResponse
	2, // 7: article.ArticleService.GetArticles:output_type -> article.ListArticlesResponse
