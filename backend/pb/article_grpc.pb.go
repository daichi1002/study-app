...
type ArticleServiceClient interface {
	...
	GetArticles(ctx context.Context, in *ListArticlesRequest, opts ...grpc.CallOption) (*ListArticlesResponse, error)
}
...
func (c *articleServiceClient) GetArticles(ctx context.Context, in *ListArticlesRequest, opts ...grpc.CallOption) (*ListArticlesResponse, error) {
...
type ArticleServiceServer interface {
	...
	GetArticles(context.Context, *ListArticlesRequest) (*ListArticlesResponse, error)
}
...
func (UnimplementedArticleServiceServer) GetArticles(context.Context, *ListArticlesRequest) (*ListArticlesResponse, error) {
...
func _ArticleService_GetArticles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServiceServer).GetArticles(ctx, req.(*ListArticlesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
